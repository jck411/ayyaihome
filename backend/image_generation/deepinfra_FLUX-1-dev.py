...
# API endpoint for the FLUX-1-dev model
...
payload = {
    "prompt": "a yokie in space",  # Main text prompt
    "num_images": 1,  # Number of images to generate (default: 1, range: 1 to 4)
    "num_inference_steps": 25,  # Number of denoising steps (default: 25, range: 1 to 50)
    ...
    "guidance_scale": 7.5,  # Classifier-free guidance; higher values follow the prompt more closely (default: 7.5, range: 0 to 20)
